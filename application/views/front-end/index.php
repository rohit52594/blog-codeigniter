	...
	<section class="bottom-slider">
		<div class="course_demo1">
			<ul id="flexiselDemo1">
				<li>
					<div class="blog-item">
						<img src="<?php echo base_url().'assets/'; ?>images/1.jpg" alt=" " class="img-fluid" />
				...
				<li>
					<div class="blog-item">
						<img src="<?php echo base_url().'assets/'; ?>images/2.jpg" alt=" " class="img-fluid" />
						<button type="button" class="btn btn-primary play" data-toggle="modal" data-target="#exampleModal">
							<i class="fas fa-play"></i>
						</button>
				...
				<li>
					<div class="blog-item">
						<img src="<?php echo base_url().'assets/'; ?>images/4.jpg" alt=" " class="img-fluid" />
						<button type="button" class="btn btn-primary play" data-toggle="modal" data-target="#exampleModal">
							<i class="fas fa-play"></i>
						</button>
			...
			<div class="row">
				...
				<div class="col-lg-8 left-blog-info-w3layouts-agileits text-left">
					...
					<div class="blog-mid-sec">
						<ul id="flexiselDemo2">
							...
							<li>
								<div class="blog-item">
									<img src="<?php echo base_url().'assets/'; ?>images/8.jpg" alt=" " class="img-fluid" />
									<button type="button" class="btn btn-primary play sec" data-toggle="modal" data-target="#exampleModal">
										<i class="fas fa-play"></i>
									</button>
									<div class="floods-text">
				...
				<aside class="col-lg-4 agileits-w3ls-right-blog-con text-right">
					<div class="right-blog-info text-left">
						<div class="tech-btm">
							<img src="<?php echo base_url().'assets/'; ?>images/banner1.jpg" class="img-fluid" alt="">
						</div>
						<div class="tech-btm">
						...
						<div class="tech-btm">
							...
							<div class="blog-grids row mb-3">
								<div class="col-md-5 blog-grid-left">
									<a href="single.html">
										<img src="<?php echo base_url().'assets/'; ?>images/1.jpg" class="img-fluid" alt="">
									</a>
								</div>
							...
							<div class="blog-grids row mb-3">
								<div class="col-md-5 blog-grid-left">
									<a href="single.html">
										<img src="<?php echo base_url().'assets/'; ?>images/3.jpg" class="img-fluid" alt="">
									</a>
								</div>
								<div class="col-md-7 blog-grid-right">
									<h5>
							...
							<div class="blog-grids row mb-3">
								<div class="col-md-5 blog-grid-left">
									<a href="single.html">
										<img src="<?php echo base_url().'assets/'; ?>images/2.jpg" class="img-fluid" alt="">
									</a>
								</div>
								<div class="col-md-7 blog-grid-right">
			...
			<div class="row inner-sec">
				<div class="col-md-4 news-left">
					<ul id="demo1_thumbs" class="list-inline">
						<li>
							<a href="<?php echo base_url().'assets/'; ?>images/m1.jpg">
								<img src="<?php echo base_url().'assets/'; ?>images/m1.jpg" alt="" data-desoslide-caption="<h3>Latest Post 1</h3>">
						...
						<li>
							<a href="<?php echo base_url().'assets/'; ?>images/m2.jpg">
								<img src="<?php echo base_url().'assets/'; ?>images/m2.jpg" alt="" data-desoslide-caption="<h3>Latest Post 2</h3>">
								<div class="mid-text-info">
									<h4>Maecenas aliqua</h4>
									<p>Integer </p>
									<div class="sub-meta">
						...
						<li>
							<a href="<?php echo base_url().'assets/'; ?>images/m3.jpg">
								<img src="<?php echo base_url().'assets/'; ?>images/m3.jpg" alt="" data-desoslide-caption="<h3>Latest Post 3</h3>">
								<div class="mid-text-info">
									<h4>Maecenas aliqua</h4>
									<p>Integer </p>
									<div class="sub-meta">
						...
						<li>
							<a href="<?php echo base_url().'assets/'; ?>images/m4.jpg">
								<img src="<?php echo base_url().'assets/'; ?>images/m4.jpg" alt="" data-desoslide-caption="<h3>Latest Post 4</h3>">
								<div class="mid-text-info">
									<h4>Maecenas aliqua</h4>
									<p>Integer </p>
									<div class="sub-meta">
					...
					<aside class="col-lg-4 agileits-w3ls-right-blog-con text-left">
						<div class="tech-btm">
							...
							<div class="blog-grids row mb-3">
								<div class="col-md-5 blog-grid-left">
									<a href="single.html">
										<img src="<?php echo base_url().'assets/'; ?>images/7.jpg" class="img-fluid" alt="">
									</a>
								</div>
								<div class="col-md-7 blog-grid-right">
									<h5>
							...
							<div class="blog-grids row mb-3">
								<div class="col-md-5 blog-grid-left">
									<a href="single.html">
										<img src="<?php echo base_url().'assets/'; ?>images/8.jpg" class="img-fluid" alt="">
									</a>
								</div>
								<div class="col-md-7 blog-grid-right">
